...
public class ID3v2UrlFrameDataTest extends TestCase {
	...
	public void testShouldConsiderTwoEquivalentObjectsEqual() throws Exception {
		ID3v2UrlFrameData frameData1 = new ID3v2UrlFrameData(false, new EncodedText(Encoding.ENCODING_ISO_8859_1, TEST_DESCRIPTION), TEST_URL);
		ID3v2UrlFrameData frameData2 = new ID3v2UrlFrameData(false, new EncodedText(Encoding.ENCODING_ISO_8859_1, TEST_DESCRIPTION), TEST_URL);
	...
	public void testShouldConvertFrameDataToBytesAndBackToEquivalentObject() throws Exception {
		ID3v2UrlFrameData frameData = new ID3v2UrlFrameData(false, new EncodedText(Encoding.ENCODING_ISO_8859_1, TEST_DESCRIPTION), TEST_URL);
	...
	public void testShouldConvertFrameDataWithUnicodeDescriptionToBytesAndBackToEquivalentObject() throws Exception {
		ID3v2UrlFrameData frameData = new ID3v2UrlFrameData(false, new EncodedText(Encoding.ENCODING_ISO_8859_1, TEST_DESCRIPTION_UNICODE), TEST_URL);
		byte[] bytes = frameData.toBytes();
